    ...
    <div className="h-screen w-full bg-slate-950 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-10 rounded-[40px] shadow-2xl backdrop-blur-2xl">
          ...
          <p className="text-slate-500 text-sm mb-8">Regístrese para acceder a su ecosistema.</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-2 ml-1">Confirmar Contraseña</label>
              <input
                type="password"
            ...
            <div className="pt-6 text-center">
              <Link to="/login" className="text-xs text-slate-500 hover:text-blue-400 transition-colors">
